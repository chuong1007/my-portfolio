...
export default function ProjectsPage() {
  ...
  const [activeTab, setActiveTab] = useState<'projects' | 'homepage' | 'analytics' | 'popup' | 'dashboard'>('projects');
        ...
        {projects.map((project, idx) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-xs text-zinc-500 line-clamp-1 mb-2">{project.description?.replace(/<[^>]*>?/gm, "")}</p>
