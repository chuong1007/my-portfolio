                  ...
                  <div className={cn(
                    ...
                    {expandedBlocks.map((block) => {
                      ...
                      cleanContent = cleanContent
                        ...
                        .replace(/Capcut/gi, '<span class="inline-flex items-center justify-center w-5 h-5 rounded-md bg-black text-white text-[10px] font-black mr-1.5 border border-white/20 shadow-[0_0_8px_rgba(255,255,255,0.1)] align-middle select-none">Cc</span>Capcut');
