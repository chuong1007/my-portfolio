...
content = content.replace(
  /<div className="flex items-center gap-0\.5 bg-\[var\(--bg-base\)\] p-1 rounded-lg border border-zinc-800\/50">[\s\S]*?\{\/\* Color Picker Toolbar Item \*\/\}/,
  alignAndTools + '\n            {/* Color Picker Toolbar Item */}'
);

fs.writeFileSync(filePath, content, 'utf8');
console.log('Fixed RichTextEditor UI');
